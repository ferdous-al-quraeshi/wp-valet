<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Valet Options', 'redux-framework-demo' ),
        'page_title'           => __( 'Valet Options', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Header Options', $opt_name ),
        'desc'             => __( "Following are your theme's header options", $opt_name ),
        'icon'             => 'el el-cog',
    ) );
    Redux::setSection($opt_name, array(
        'subsection'       => true,
        'title'            => __('Logo', 'valet'),
        'desc'             => __('Manage the logo of your site here!', $opt_name),
        'icon'             => 'el el-upload',
        'fields'           => array(
            array(
                'id'                => 'header-logo',
                'title'             => __('Header Logo Uploader', $opt_name),
                'subtitle'          => __('Upload your header logo here', $opt_name),
                'desc'              => __( "Just click or drag'n'drop your logo here", $opt_name ),
                'type'              => 'media',
                'url'               => true,
    ...
    // Banner / Hero section
    Redux::setSection($opt_name, array(
        'title'            => __('Hero', $opt_name),
        'desc'             => __('Manage the common Hero section of your pages here!', $opt_name),
        'icon'             => 'el el-puzzle',
    ));
    Redux::setSection($opt_name, array(
        'subsection'       => true,
        'title'            => __('Hero Background', $opt_name),
        'desc'             => __('Manage Hero Image or Background of your pages here!', $opt_name),
        'icon'             => 'el el-screen-alt',
        'fields'           => array(
            array(
                'id'                => 'hero-bg',
                'title'             => __('Hero Background Image / Color', $opt_name),
                'subtitle'          => __('Set your Hero bacground image or color here', $opt_name),
                'desc'              => __( "Just click on the <i><b>select color</b></i> panel and set required color", $opt_name ),
                'type'              => 'color',
                'default'           => '#57cecd',
            )
        )
    ...
    Redux::setSection($opt_name, array(
        'subsection'       => true,
        'title'            => __('Hero Contents', $opt_name),
        'desc'             => __('Manage Hero Contents for the required pages here!', $opt_name),
        'icon'             => 'el el-file-edit',
        'fields'           => array(
            array(
                'id'                => 'hero-header',
                'title'             => __('Hero Heading', $opt_name),
                'subtitle'          => __('Set your Hero big heading here', $opt_name),
                'desc'              => __( "Put your texts into the text input box and make save it", $opt_name ),
                'type'              => 'text',
                'default'           => "Valet Multi-Purpose Free HTML5 Bootstrap Template",
            ),
            array(
                'id'                => 'hero-subheader',
                'title'             => __('Hero Sub-heading', $opt_name),
                'subtitle'          => __('Set your Hero sub-heading here', $opt_name),
                'desc'              => __( "Put your texts into the text input box and make save it", $opt_name ),
                'type'              => 'text',
                'default'           => 'Created by <a href="http://freehtml5.co" target="_blank">FREEHTML5.co</a>',
            ),
